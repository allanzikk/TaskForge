...
def create_app():
    ...
    cors.init_app(app, origins=["https://taskforge.app.br", "http://127.0.0.1:5000", "http://localhost:5000"], methods=["GET", "POST", "PATCH", "PUT", "DELETE", "OPTIONS"], allow_headers=["Content-Type", "Authorization"])
